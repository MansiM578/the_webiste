    ...
    <div className="bg-[#3b81dc]">
      <div className=" max-w-[1240px] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-white">
        ...
        <div className="lg:col-span-2 flex justify-between mt-6">
          <div>
            <h6 className="font-medium text-black">Heading</h6>
            <ul>
              <li className="py-2 text-sm">Item1</li>
              <li className="py-2 text-sm">Item2</li>
              <li className="py-2 text-sm">Item3</li>
              <li className="py-2 text-sm">Item3</li>
            </ul>
          </div>
          <div>
